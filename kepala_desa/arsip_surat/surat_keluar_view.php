...
$status_badges = [
    ...
    'TERBIT' => '<span class="badge bg-info text-dark">TERBIT</span>',
        ...
        <div class="pc-content">
            <div class="row">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        <a href="surat_keluar_edit.php?id=<?= $surat['id'] ?>" class="btn btn-warning me-2">
                            <i class="ti ti-edit"></i> Edit
                        </a>
                        <a href="list.php?tab=keluar" class="btn btn-secondary">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <h6 class="text-muted mb-3">Detail Penerima</h6>
                                    <table class="table table-borderless">
                                        <tr>
                                            <td style="width: 40%;">
                        ...
                        <div class="card-footer bg-light d-flex justify-content-between">
                            ...
                            <div>
                                <a href="surat_keluar_edit.php?id=<?= $surat['id'] ?>" class="btn btn-sm btn-warning">
                                    <i class="ti ti-edit me-1"></i>Edit Surat
                                </a>
                                <a href="list.php?tab=keluar" class="btn btn-sm btn-secondary">
