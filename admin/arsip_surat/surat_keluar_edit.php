...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    ...
    header("Location: list.php?tab=keluar");
    exit();
}
...
$status_options = ['DRAFT', 'TERBIT', 'TERKIRIM', 'ARSIP'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $form_data['tujuan'] = trim($_POST['tujuan'] ?? '');
    ...
    if (empty($form_data['nomor_surat'])) {
        ...
        $check_sql = "SELECT id FROM tabel_surat_keluar WHERE nomor_surat = ? AND id != ?";
    ...
    if (empty($form_data['tujuan'])) {
        $errors['tujuan'] = 'Tujuan wajib diisi';
    } elseif (strlen($form_data['tujuan']) > 200) {
        $errors['tujuan'] = 'Tujuan maksimal 200 karakter';
    }
    ...
    if (empty($errors)) {
        try {
            ...
            if ($file_surat && $file_surat['error'] === 0) {
                ...
                $file_extension = strtolower(pathinfo($file_surat['name'], PATHINFO_EXTENSION));
                $uploaded_file_name = 'surat_keluar_' . time() . '_' . uniqid() . '.' . $file_extension;
            ...
            if ($stmt->execute()) {
                ...
                $_SESSION['success'] = 'Surat keluar berhasil diperbarui!';
...
<head>
    ...
    <title>Edit Surat Keluar - Sistem Administrasi Desa</title>
    <style>
        .required:after {
            content: " *";
            color: red;
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="ti ti-edit me-2"></i>Edit Surat Keluar</h5>
                        </div>
                        <div class="card-body">
                            <!-- Breadcrumb -->
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="list.php?tab=keluar">Arsip Surat</a></li>
                            ...
                            <form method="POST" action="" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Contoh: 005/SK/VI/2024"
                                                required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <?php if (isset($errors['tujuan'])): ?>
                                                <div class="error-message"><?= $errors['tujuan'] ?></div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <div>
                                        <a href="list.php?tab=keluar" class="btn btn-secondary btn-back">
        ...
        function previewFile() {
            ...
            if (fileInput.files.length > 0) {
                ...
                previewArea.innerHTML = `
                    <i class="ti ti-file-text" style="font-size: 48px; color: #198754;"></i>
