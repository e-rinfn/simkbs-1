                    ...
                    <div class="tab-pane fade <?= $active_tab === 'masuk' ? 'show active' : '' ?>"
                        ...
                        <div class="card p-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="btn-group">
                                    <a href="export_surat_masuk_excel.php?<?= http_build_query($_GET) ?>" class="btn btn-excel">
                                        <i class="ti ti-file-spreadsheet"></i> Excel
                                    </a>
                                    <a href="export_surat_masuk_pdf.php?<?= http_build_query($_GET) ?>" class="btn btn-pdf">
                    ...
                    <div class="tab-pane fade <?= $active_tab === 'keluar' ? 'show active' : '' ?>"
                        ...
                        <div class="card p-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="btn-group">
                                    <a href="export_surat_keluar_excel.php?<?= http_build_query($_GET) ?>" class="btn btn-excel">
                                        <i class="ti ti-file-spreadsheet"></i> Excel
                                    </a>
                                    <a href="export_surat_keluar_pdf.php?<?= http_build_query($_GET) ?>" class="btn btn-pdf">
                                        <i class="ti ti-file-text"></i> PDF
                                    </a>
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php foreach ($data_surat_keluar as $surat): ?>
                                                ...
                                                // Format tanggal
                                                $tanggal_surat = !empty($surat['tanggal_surat']) ? date('d/m/Y', strtotime($surat['tanggal_surat'])) : '-';
                                                $tanggal_kirim = !empty($surat['tanggal_kirim']) ? date('d/m/Y', strtotime($surat['tanggal_kirim'])) : '-';
