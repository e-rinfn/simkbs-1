...
// Buat nama file
$filename = 'arsip_surat_keluar_' . date('Ymd_His') . '.xls';
...
<head>
    ...
    <style>
        ...
        th { background-color: #198754; color: white; font-weight: bold; padding: 8px; border: 1px solid #ddd; }
...
if (count($data_surat) > 0) {
    ...
    echo '<tr><td colspan="8" align="center">Tidak ada data surat keluar</td></tr>';
}
